...
CLAUDE.md 文首用 `@.claude/rules/<file>.md` import 把下列规则文件纳入记忆。Claude Code / ZCode 读取 CLAUDE.md 时会一并加载这些规则，使助手成为伙伴/伴侣式协作者。

## 规则文件

| 文件 | 领域 | 来源（CLAUDE.md 章节） | 备注 |
|------|------|------------------------|------------------------|
| [`00-core.md`](00-core.md) | 核心原则、目录拓扑、禁止项、根目录白名单 | §1、§2、§2.1、§6 | indexed-core、workspace-readmes、wok-plans |
...
- 新增领域规则时：在本表补一行，并在 CLAUDE.md 文首 import 段补 `@.claude/rules/<file>.md`。
