...
根目录允许的工作区/工具配置目录（除五个工作桶 + 框架设施 `ix-gui/` + 元文件外）：
...
仅允许：`CLAUDE.md`、`VERSION`、`.gitignore`、`README.md`、`.claude/`，以及五个工作桶（`_shared/`、`reports/`、`research/`、`artifacts/`、`ix-agents/`）+ 框架设施 `ix-gui/`。
