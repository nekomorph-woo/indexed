...
根目录允许的工作区/工具配置目录（除五个工作桶<!-- IX_GUI_SECTION_BEGIN --> + 框架设施 `ix-gui/`<!-- IX_GUI_SECTION_END --> + 元文件外）：
...
仅允许：`CLAUDE.md`、`VERSION`、`.gitignore`、`README.md`、`.claude/`，以及五个工作桶（`_shared/`、`reports/`、`research/`、`artifacts/`、`ix-agents/`）<!-- IX_GUI_SECTION_BEGIN -->+ 框架设施 `ix-gui/`<!-- IX_GUI_SECTION_END -->。
